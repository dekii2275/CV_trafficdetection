...
def interactive_loop(stats_path, classes, interval=30, agg_freq="1min", minutes_window=10):
    plt.ion()
...
def headless_loop(stats_path, classes, interval=30, agg_freq="1min", minutes_window=10):
    from visualize import (
        plot_line_chart,
        plot_grouped_bar_minute,
        plot_area_chart,
